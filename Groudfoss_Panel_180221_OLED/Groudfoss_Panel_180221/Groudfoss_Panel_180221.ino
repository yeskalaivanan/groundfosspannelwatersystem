...
void OLED_DISPLAY1()
{
  ...
  //display.println(F("Welcome To VEPL")); 

  if (Select_Master == 0)
  {
  display.print(MOTOR1_STATUS);
  display.print("M ");
  display.print(MOTOR2_STATUS);
  display.print(" ");
  display.println(MOTOR3_STATUS); 
  }
  else if (Select_Master == 1)
  {
  display.print(MOTOR3_STATUS);
  display.print(" ");
  display.print(MOTOR1_STATUS);
  display.print("M");
  display.println(MOTOR2_STATUS); 
  }
...
void OLED_DISPLAY2()
{
  ...
  display.print(SetPSValue);  
  display.println("b ");

  display.print(ReadPSValue);
  display.println("b");
